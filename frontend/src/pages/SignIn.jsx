...
function SignIn() {
  ...
  return (
    <div className='w-full min-h-screen flex justify-center items-center relative overflow-hidden bg-slate-50'>
      ...
      <div className='absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] rounded-full bg-blue-200 blur-[100px] opacity-60'></div>
      <div className='absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-purple-200 blur-[120px] opacity-50'></div>
      <div className='absolute top-[20%] right-[10%] w-[30vw] h-[30vw] rounded-full bg-pink-100 blur-[90px] opacity-60'></div>
      
      <form 
        className='w-[90%] max-w-[420px] bg-white/70 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl flex flex-col items-center justify-center gap-5 p-10 relative z-10 border border-white/50' 
      ...
      >
        <div className='text-center mb-4'>
          ...
          <p className='text-slate-500 text-sm'>
            Enter your details to access your assistant
          </p>
        </div>
        ...
        <p className='text-slate-500 text-sm text-center mt-6'>
          ...
          <span 
            className='text-blue-600 hover:text-blue-700 cursor-pointer font-medium transition-colors hover:underline underline-offset-4' 
